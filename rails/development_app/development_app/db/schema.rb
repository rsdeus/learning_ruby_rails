...
ActiveRecord::Schema.define(version: 2022_08_18_184319) do
  ...
  create_table "decidim_banned_users", force: :cascade do |t|
    t.bigint "banned_user_id"
    t.bigint "admin_reporter_id"
    t.datetime "notified_at"
    t.datetime "removed_at"
    t.string "banned_email"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "justification"
    t.index ["admin_reporter_id"], name: "index_decidim_banned_users_on_admin_reporter_id"
    t.index ["banned_email"], name: "index_decidim_banned_users_on_banned_email"
    t.index ["banned_user_id"], name: "index_decidim_banned_users_on_banned_user_id"
  end
  ...
  add_foreign_key "decidim_banned_users", "decidim_users", column: "admin_reporter_id"
  add_foreign_key "decidim_banned_users", "decidim_users", column: "banned_user_id", on_delete: :nullify
